...
On the other hand, the driving functions given by \eqref{eq:SDM_rayleigh} inherently contains the SPA in the $x$-direction, and the referencing curve concept, since the driving functions derived ensure an optimal synthesis at 
\begin{equation}
...
\begin{equation}
D(x_0) = 
\sqrt{ \frac{8\pi \ti \yref }{\left| \yref\phi^{''}_{P,z_0,z_0}(x_0,0,0	) - k^l_{y,P}(x_0) \right|}}
