...
c\subsection{Application example}
\begin{figure}
	\centering
...
\frac{P(x^*(x_0),y)}{G(x^*(x_0) - x_0,y)}.
\end{equation}
and as a final result one obtains the driving functions written in terms of the target field, written on the SDM
\begin{equation}
D(x_0) \approx -2
\sqrt{ \frac{2\pi}{\ti \left| \phi^{''}_{P,z_0,z_0}(x_0,0,0	) + \phi^{''}_{G,z_0,z_0}(x^*(x_0) - x_0,y,0) \right|}}
