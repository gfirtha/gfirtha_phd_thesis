...
%Temp:\\
%Integration with respect to $z$ can be therefore approximated as
%\begin{equation}
%P(x^*,y,\omega) \approx -2\sqrt{\frac{2\pi}{\ti |A|}} \frac{\partial}{\partial y} P(x,0,0,\omega) G(x^*-x,y,0,\omega),
%\end{equation}
%where
%\begin{equation}
%A =
% \frac{\partial^2}{\partial z_0^2} \phi(x_0,z_0)\cdot \frac{\partial^2}{\partial x_0^2} \phi(x_0,z_0) -
% \left( \frac{\partial^2 }{\partial z_0 x_0}   \phi(x_0,z_0)\right)^2. 
%\end{equation}
