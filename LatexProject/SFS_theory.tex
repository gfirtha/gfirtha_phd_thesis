...
\begin{equation}
P_{\mathrm{s}}(\vxo,\omega) = -P(\vxo,\omega), \hspace{5mm} \frac{\partial}{\partial \vni} P_{\mathrm{s}}(\vxo,\omega) = -\frac{\partial}{\partial \vno} P(\vxo,\omega), \hspace{5mm} \vxo \in \partial \Omega.
...
The equation forms the basis of traditional \emph{Wave Field Synthesis}, thus equation \eqref{Eq:Theory:2D_3D_WFS_driv_fun} is referred to as \emph{2D} and \emph{3D WFS driving functions}.
...
\end{equation}
The high-frequency driving functions therefore are given by the planar driving functions taken locally on the SSD surface.
