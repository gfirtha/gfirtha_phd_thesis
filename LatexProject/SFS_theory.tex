...
\end{equation}
with $k_y = \sqrt{ \left( \frac{\omega}{c} \right )^2 - k_x^2 - k_z^2 }$, thus the angular spectrum of the Green's function placed at the origin ($\vxo = [0,\ 0,\ 0]^{\mathrm{T}}$) measured at a fixed $y$ is given as (as it was shown in table \ref{table:theory:Greens_fun_representations} ):
\begin{equation}
