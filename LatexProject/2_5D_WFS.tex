...
\subsubsection{Unified 2.5D driving functions}
...
Let's generalize the 2.5D WFS driving functions towards
\begin{equation}
D(x_0,\omega) = 
- \sqrt{\frac{8\pi}{\ti k}} \sqrt{d(x_0)} \left. \frac{\partial P(\vx,\omega)}{\partial y}\right|_{\vx = \vxo},
\label{Eq:Gen_rayleigh_dx0}
\end{equation}
which is obviously a common generalization of \eqref{eq:25D_WFS:25D_neumann_2D} and \eqref{eq:25D_WFS:25D_neumann_general}.
