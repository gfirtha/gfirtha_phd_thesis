...
The integral implicitly contains the---yet receiver position dpeendent---2.5D driving functions, given for a general 3D virtual field by
\begin{equation}
D_{3\text{D}}(\vxo,\omega) = -2 w(\vxo) \sqrt{\frac{2 \pi}{\ti \left| \phi''_{P,z,z}(\vxo,\omega) +  \phi''_{G,z,z}(\vx - \vxo,\omega) \right|}}
\frac{\partial P(\vxo,\omega)}{\partial \vni},
\end{equation}
which simplifies to
\begin{multline}
D_{2\text{D}}(\vxo,\omega) = -2 w(\vxo) \sqrt{\frac{2 \pi}{\ti \left|\phi''_{G,z,z}(\vx - \vxo,\omega) \right|}}
\frac{\partial P(\vxo,\omega)}{\partial \vni} = \\ =-2 w(\vxo) \sqrt{\frac{2 \pi |\vx-\vxo|}{\ti k}}
\frac{\partial P(\vxo,\omega)}{\partial \vni} ,
\end{multline}
for a 2D virtual field.
