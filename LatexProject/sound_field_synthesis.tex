...
Expressing the second derivatives in terms of the principal radii according to \eqref{Eq:App:Hessian_inplane} the driving function can be expanded into the form
\begin{equation}
...
Furthermore, within the validity of the Kirchhoff-approximation the SSD doues not necessarily need to be linear: the spatial explicit driving functions can be applied using an arbitrary shaped SSD contour.
...
This local increase of synthesis accuracy is usually referred to as \emph{Local Wave Field Synthesis (LWFS)}, being the subject of extensive study in the recent years.
