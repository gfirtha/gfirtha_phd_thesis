...
\subsection*{Application example: Synthesis applying discrete secondary source distribution}
\label{Sec:Aliasing}

Throughout this thesis so far synthesis applying a continuous distribution of secondary sources has been discussed.
...
The violation of the continuous SSD assumptions leads to severe artifacts in the synthesized field, commonly referred to as \emph{spatial aliasing phenomena}.
An advantage of the explicit solution is that it is able to analytically describe such aliasing artifacts, which above the foregoing can be directly applied to the results concerning WFS as well.
Hence, as a complex application example the investigation and avoidance of spatial aliasing is investigated.
