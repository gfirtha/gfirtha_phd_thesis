...
For the special case of the 3D Green's function $\rho^G_1(\vx-\vxo^*) = \rho^G_s(\vx-\vxo^*) = |\vx-\vxo^*|$ holds and by substituting the explicit expression for the Green's function the equation simplifies to
\begin{equation}
P(\vx) \approx 
P(\vxo^*(\vx))
...
\te^{-\ti k |\vx-\vxo^*(\vx)|},
\end{equation}
where $\rho^P_1(\vx) \, \rho^P_2(\vx)$ is the reciprocal of the Gaussian curvature of the wavefront.
