...
\small
  \begin{minipage}[c]{0.64\textwidth}
	...
	In order to ensure a smooth driving function and avoid truncation artifacts for these SSD positions the amplitude correction term is extrapolated by nearest-neighbor.
    }
