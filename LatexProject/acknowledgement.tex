 \fscom{replace all 'SSD elements' with 'secondary sources' as in IEEE18?}
...
\fscom{Ch 5 moving: replace 'boundary' by SSD to be consistent with Ch 3,4?}

\fscom{driving functions vs. driving function}

\fscom{check multiple equation labels and correct referenceing to them, wrong links appear often in Ch 5}

\fscom{check correct usage of arbitrary vs. arbitrarily}
...
source-free,
steady-state,
\item anti-aliasing, low-pass filter
\item traveling
