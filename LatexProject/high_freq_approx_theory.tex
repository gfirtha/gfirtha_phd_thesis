...
The principal curvature components $\kappa_1^P(\vx),\kappa_2^P(\vx)$ are defined geometrically as the reciprocal of the the maximal and minimal radii of osculating spheres at a point on the wavefront, as illustrated in Figure \ref{Fig:HF_appr:local_wave_curvature}.
