The boundary integral representations introduced in the previous section give the possibility for solving the sound field synthesis problem for special geometries, or at the expense of great computational complexity.
...
\end{equation}
%
\fscom{give a note that this holds for the used time/space convention in the Fourier transforms}
...
(c-d) show the local normalized $\hat{k}_x(x,y_0)$ component along the line $y_0 = 0.5 ~\mathrm{m}$.\fscom{0.5m line in fig a might be helpful}
}
