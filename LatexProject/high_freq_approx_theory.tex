...
These approximations will be later of crucial interest for finding the loudspeaker driving functions for general loudspeaker contours.
...
\end{equation}
Obviously, in order to have the equality satisfied for an arbitrary sound field both real and imaginary parts of the bracketed term have to vanish, resulting in the following equations:
...
It is important to note that the local dispersion relation is only valid in the present form for a stationary sound field and in isotropic media.
