...
This geometry is termed as a baffled radiator, that's radiated field at an arbitrary receiver position $\vx = \posvec{3}{x}{y>0}{z}$ is given by the Rayleigh I integral \cite{Eq:Theory:RayleighI} written in terms of the normal velocity
\begin{equation}
