...
Eigenvectors $\lambda_1$ and $\lambda_2$ may be arbitrary orthogonal vectors in the plane, tangent to the surface in the point of investigation $\vx$, with the corresponding principal curvatures being $\kappa_1^G(\vx) = \kappa_2^G(\vx) = 1/|\vx| $.
