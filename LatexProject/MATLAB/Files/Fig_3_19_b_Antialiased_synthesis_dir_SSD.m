...
loudspeaker_type = 'piston'; % Loudspeaker directivity: ideal spatial LP ('ideal') / piston
ds = 0.1;
...
[ field_synth_aa ] = get_synthesized_field( t,s, Amp,xs,'on' ,loudspeaker_type, 'on', Dref,kn,r0, xrec0, x_ssd, N_ssd, X,Y,kv,kv0 );
%
%%
ftsize = 13.75;
...
%print( '-r300',fullfile( '../..','Figures/SFS_theory','Antialiased_synth_dir_SSD' ) ,'-dpng')