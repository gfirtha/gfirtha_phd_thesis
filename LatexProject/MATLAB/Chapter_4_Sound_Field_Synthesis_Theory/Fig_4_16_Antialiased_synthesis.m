...
[ field_synth ] = get_synthesized_field( t,s, Amp,xs,'off' ,loudspeaker_type, 'off', Dref,kn,r0, xrec0, x_ssd, N_ssd, X,Y,kv,0 );
[ field_synth_aa ] = get_synthesized_field( t,s, Amp,xs,'on' ,loudspeaker_type, 'off', Dref,kn,r0, xrec0, x_ssd, N_ssd, X,Y,kv,0 );
[ field_synth_aarp ] = get_synthesized_field( t,s, Amp,xs,'on' ,loudspeaker_type, 'on', Dref,kn,r0, xrec0, x_ssd, N_ssd, X,Y,kv,0 );
%
%%
