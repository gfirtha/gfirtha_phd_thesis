...
A hangtér-reprodukció általános elrendezése \azr{fig:introduction:sfs_aim}. ábrán látható.
...
Ez az általánosítás már lehetővé tette összetettebb hangterek szintézisét is, így pl. egy mozgó forrásét,\footfullcite{Ahrens2008moving} azonban a módszer  3D virtuális tér reprodukciója esetén még a referenciapontban is amplitúdóhibákhoz vezetett.
...
Kör és egyenes másodlagos forráseloszlás geometriák esetén bizonyos virtuális terekre megmutatható, hogy a hangtérszintéis az explicit, direkt megoldás nagyfrekvenciás közelítésének tekinthető.\footfullcite{Ahrens2012}\textsuperscript{,}\footfullcite{Spors2010:analysis_and_improvement}
...
Ahrens az újragondolt hangtérszintézis elméletet terjesztette ki mozgó forrásokra is.\footfullcite{Ahrens2008moving}\textsuperscript{,}\footfullcite{Ahrens2008moving_b}
...
Egyszerű példaként \azr{fig:SFS_theory:25D_WFS_generals}.\ ábra egy 3D pontforrás általános alakú másodlagos forráseloszlással történő szintézisét mutatja be.
...
Ezek az átlapolódó ,,visszhangok'', amelyek az egyes hangszóró vezérlőfüggvények az \emph{átlapolódási frekvencia} feletti komponenseit tartalmazzák, \azr{fig:SFS_theory:anti-aliased_synthesis}. (a) ábrán figyelhetők meg.
...
A módszer alkalmazásával a megfigyelési terület egy kitüntetett iránya mentén átlapolódásmentes, széles sávú szintézis valósítható meg, ahogy az \azr{fig:SFS_theory:anti-aliased_synthesis}. (b) ábra mutatja.
...
A módszer alkalmazását \azr{fig:SFS_theory:25D_WFS_moving_source}. ábra szemlélteti egy egyenletesen mozgó harmonikus forrás szintézisének példáján keresztül.
...
Ezt az esetet szemlélteti \azr{Fig:Moving_sources:anti-aliased_synth_moving_source}. ábra egy általános görbe pálya mentén mozgó impulzussorozat-gerjesztésű forrás szintézise esetén.
