...
\author{\theauthor}
\title{A Generalized Wave Field Synthesis Theory\\[.5ex] \large with Application for Moving Virtual Sources}
...
This possibility is discussed in \cite{Winter2019:aliasing} for which I serve as a co-author.
...
These driving functions serves as a reference solution, since it results in perfect synthesis over the reference line. 
